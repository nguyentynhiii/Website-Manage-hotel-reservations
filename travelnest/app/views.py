...
def ks(request):
    ...
    for phong in phongs:
        anhs = Anh.objects.filter(phong=phong)
    ...
    context={'danhgias':danhgias,'tong_danhgia':tong_danhgia,'check_in':check_in,'check_out':check_out,'tendiem_tb':tendiem_tb,'diemtb_danhgia':diemtb_danhgia,'anhs':anhs,'tiennghis':tiennghis,'phongs': phongs,'phong_trong':phong_trong, 'khachsan':khachsan,'khachsan_id':khachsan_id, 'khachsan_name':khachsan_name,'tinh_name':tinh_name,'tinh_id':tinh_id}
